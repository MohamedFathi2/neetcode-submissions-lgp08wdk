class SuperHero:
    ...
    def set_power_level(self, new_power_level) -> None:
        if 1 <= new_power_level <= 10:
            ...
            return
        elif new_power_level < 1: print("You can't set the power level to less than 1")
        else: print("You can't set the power level to more than 10")
    ...
    def set_health(self, new_health):
        ...
        elif new_health > 100 : print("You can't set the health to more than 100")
        else: print("You can't set the health to less than 0")
